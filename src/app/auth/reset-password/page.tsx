...
export default function ResetPasswordPage() {
  return (
    <>
      <div className='flex items-center justify-center w-screen border-b border-separator'>
        <header className='flex items-center justify-between w-[935px] h-16'>
          <svg
      ...
      <div className='w-[390px]'>
        <main className='flex flex-col items-center justify-center gap-3 p-10 border border-separator mt-14'>
          <svg
        ...
        <div className='w-[390px] bg-popover text-center p-3 hover:bg-popoverHover'>
