  ...
  return (
    <main className='w-[350px] py-3'>
      <div className='border-border flex w-[350px] flex-col border py-[10px]'>
        ...
        <button className='text-link hover:text-link-hover mt-2 mb-5 cursor-pointer font-semibold'>
          Sign in as a guest
        </button>
      ...
      <div className='border-border mt-3 w-[350px] border p-5 text-center'>
        ...
        <Link
          href={'/auth/login'}
          className='text-link hover:text-link-hover active:text-link/50 text-sm font-semibold'
        >
          Log in
        </Link>
      </div>
